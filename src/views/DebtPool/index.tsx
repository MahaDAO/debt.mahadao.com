  ...
  return (
    <div className='custom-container' style={{ marginTop: '110px', }}>
      <div className="m-b-40">
        ...
        <CardSubHeader>
          The debt pool is a platform for holders to get reimbursed from protocol revenue. You can burn your debt tokens for USDC that gets collected from the protocol's revenue at a 1:1 ratio. Or you can choose
